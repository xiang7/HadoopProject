...
keep only title and body  ("id","title","body","tags"'\n' all fields can have newlines within)
...
getField - read one field with staring " and ending ", don't stop when "" is met

getField four times and the ending new line. ignore the first and the last. for the two fields left, run the steps above
